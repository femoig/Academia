...
namespace Academia.Controllers
{
    public class ExerciciosController : Controller
    {
        ...
        {
            return View(await _context.Exercicio
                .Include(t => t.Treino)
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Series,Repeticoes")] Exercicio exercicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Series,Repeticoes")] Exercicio exercicio)
        {
            if (id != exercicio.Id)
            {
                return NotFound();
